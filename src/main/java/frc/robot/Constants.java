...
public final class Constants {
  ...
  public static final class Swerve {
    ...
    public static final double angleGearRatio = ((150 / 7) / 1); // 150/7:1
    ...
    public static final class Mod0 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(43.417);
    ...
    public static final class Mod1 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(35.508);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
          canCoderID, angleOffset);
    }
    ...
    public static final class Mod2 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(329.326);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
          canCoderID, angleOffset);
    }
    ...
    public static final class Mod3 {
      ...
      public static final Rotation2d angleOffset = Rotation2d.fromDegrees(53.701);
      public static final SwerveModuleConstants constants = new SwerveModuleConstants(driveMotorID, angleMotorID,
          canCoderID, angleOffset);
    }
  }
