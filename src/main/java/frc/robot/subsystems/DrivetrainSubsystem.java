...
public class DrivetrainSubsystem {
  ...
  {
        return new SwerveModuleState(module.getDriveVelocity(), 
        new Rotation2d(Units.degreesToRadians(module.getSteerAngle())));
  }
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
        ...
        {
                m_frontLeftModule.set(states[0].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE, m_frontLeftModule.getSteerAngle());
                m_frontRightModule.set(states[1].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE, m_frontRightModule.getSteerAngle());
                m_backLeftModule.set(states[2].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE, m_backLeftModule.getSteerAngle());
                m_backRightModule.set(states[3].speedMetersPerSecond / MAX_VELOCITY_METERS_PER_SECOND * MAX_VOLTAGE, m_backRightModule.getSteerAngle());
        } else {
